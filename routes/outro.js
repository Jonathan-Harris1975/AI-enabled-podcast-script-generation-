...
router.post('/', async (req, res) => {
  try {
    ...
    const seoPrompt = getSEOKeywordsPrompt('{{DESCRIPTION_PLACEHOLDER}}'); // Replace later with real description
    const artworkPrompt = getArtworkPrompt('{{DESCRIPTION_PLACEHOLDER}}'); // Replace later with real description
